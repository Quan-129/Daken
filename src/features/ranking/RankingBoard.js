            ...
            <div class="leaderboard-container">
                <div class="header-section">
                    <div class="dropdown-container">
                        <div class="dropdown-box"><span>Top 50</span>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        </div>
                        <div class="dropdown-menu">
                            <div class="dropdown-item" data-type="top">Top 50</div>
                            <div class="dropdown-item" data-type="friends">Friends</div>
                            <div class="dropdown-item" data-type="global">Global</div>
                        </div>
                    </div>
                ...
                <div class="personal-row">
                    <div class="pb-icon-box">PB</div>
                    <div class="info-col">
                        <div class="pb-rank-text">Your Best</div>
                        <div class="player-score"><span class="hl">0</span></div>
                    </div>
                    <div class="stats-col">
                        <div class="mode-tag">CHILL</div>
                        <div class="acc-text">0%</div>
                    </div>
                </div>
            </div>`;
    }
